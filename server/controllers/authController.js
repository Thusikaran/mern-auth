...
export const register =  async (req,res)=>{
    ...
    try{
        ...
        const hashedPassword = await bcrypt.hash(password,10)// any number 5-15 more time ecript
        ...
        res.cookie('token',token,{
            ...
            maxAge : 7 * 24 * 60 * 60 * 1000                          // 7 day convert millisecound
        })

        //sendimg welcome email
        const  mailOptions={
            from : process.env.SENDER_EMAIL,
            to:email,
            subject:"Welcome to LOL ",
            text:`Welcome to LOL website . your account has 
